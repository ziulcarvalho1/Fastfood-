...
shinyServer(
  function(input,output){
    ...
    inputData <- reactive({
        ...
        value = (c(input$precip, input$tempmax, input$tempmin,input$tempmed, input$humid, input$sun, input$day, input$mes))
    ...
    df_5 <- reactive({
      ...
      df_1 <- data.frame(name = c("Desserts",  "Pizzas", "Beverage", "Sfihas", "Snack","Pastas", "Dishes", "Savory","Salads"),value1 = c(quant19,quant20,quant21,quant22,quant23,quant24,quant25,quant26,quant27))

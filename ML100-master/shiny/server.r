...
shinyServer(
  function(input,output){
    ...
    df_5 <- reactive({
      ...
      setwd("/Users/stantaov/Desktop/DS/YorkU/ML/1 - Machine Learning in Business Context/Assignment 1/shiny app v5/")
      ...
      write.csv(data1x,"/Users/stantaov/Desktop/DS/YorkU/ML/1 - Machine Learning in Business Context/Assignment 1/shiny app v5/result-06.csv")
    ...
    data2x <- read.csv("/Users/stantaov/Desktop/DS/YorkU/ML/1 - Machine Learning in Business Context/Assignment 1/shiny app v5/result-06.csv") 
    print(data2x)
    print(df_5)
    library(ggplot2)
